...
// Replaced Lombok usage with explicit code to avoid requiring the Lombok
// annotation processor in the build environment.
...
public class FieldConstants {
  ...
  public static class Outpost {
    ...
    public static class Corners {
        public static final Translation3d right = new Translation3d(1.25, 1.0, 0.0);
