...
public final class ShooterConstants {
    ...
    public static final LoggedTunableNumber kPTurret = new LoggedTunableNumber("Turret/kP", 4.0);
	...
	public static final LoggedTunableNumber turretMaxPercentOutput = new LoggedTunableNumber("Turret/MaxPercentOutput", 0.30);
